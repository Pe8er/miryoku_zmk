...
* Notes on this fork
- adds left/right hand specific macros for home row mods
- configures them for my corne using cross-hand positional hold-taps https://zmk.dev/docs/behaviors/hold-tap#home-row-mods
